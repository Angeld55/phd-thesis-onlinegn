...
% --- Заглавни данни ---
\title[Предзащита на дисертационен труд]{Предзащита на дисертационен труд}
...
\begin{frame}{Цел и задачи на дисертационния труд}
  \begin{columns}[T]
    ...
    \column{0.48\textwidth}
        ...
        \vbox to 2cm{
          \vspace{0.1cm}
          \small Разработване и реализиране на алгоритъм за преобразуване на \textit{SVG} изображение на обобщена мрежа в \textit{TeX} формат за лесно използване в научни публикации.
          \vfil
        }
      \end{block}
...
% ------------------------------------------------------------------
% --- Слайд 8 - (Задача 2)
\begin{frame}{Алгоритъм за преобразуване на \textit{SVG} изображение на обобщена мрежа в \textit{TeX} формат (Задача 2)}
\begin{center}
...
% --- Слайд 8.2 - (Задача 2)
\begin{frame}{Алгоритъм за преобразуване на \textit{SVG} изображение на обобщена мрежа в \textit{TeX} формат (решение на Задача 2)}
    \begin{center}
            ...
            \begin{block}{Основни стъпки в алгоритъма}
                \vbox to 4.1cm{
                    ...
                    \begin{itemize}
                        ...
                        \item Създаване на \textit{TeX} изображение.
                    \end{itemize}
                    \vfil
                }
            \end{block}
...
% ------------------------------------------------------------------
% --- Слайд 10 - (Задача 4)
\begin{frame}{Проектиране на архитектурата на системата \textit{OnlineGN} (Задача 4)}
    \centering
...
\begin{itemize}
    ...
    \item Dimitriev, A.; Terziev, G. \textbf{Automating Creativity: Enhancing Generalized Nets with Algorithmic Drawing.} \textit{Proc. of 22nd Int. Workshop on IFS and GN}, Warsaw, 2024 (in press).

    \item Dimitriev, A. \textbf{Representing Finite-State Automata with Generalized Nets: Simulation via OnlineGN.} \textit{Proc. of the Jangjeon Mathematical Society}, vol. 29, no. 1, 2026.

    \item Dimitriev, A.; Atanassov, K.; Angelova, N. \textbf{Parallel Towers of Hanoi via Generalized Nets: Simulated with OnlineGN.} \textit{Software}, vol. 4, no. 4 (2025).

    \item Stratiev, D. D.; Dimitriev, A. et al. \textbf{Modeling the Production Process of Fuel Gas, LPG, Propylene, and Polypropylene...} \textit{Mathematics} \textbf{2023}, 11(18), 3800.

    \item Stratiev, D. D.; Dimitriev, A. et al. \textbf{Generalized Net Model of Heavy Oil Products' Manufacturing...} \textit{Mathematics} \textbf{2023}, 11(22), 4753.
\end{itemize}
\end{frame}

% ------------------------------------------------------------------
% --- Слайд 31 - ДОПЪЛНЕН
\begin{frame}{Участие в научни конференции}
\begin{itemize}
    \setlength{\itemsep}{1.5em} 
    
    \item Доклад на „Twenty Second International Workshop on Intuitionistic Fuzzy Sets and Generalized Nets“ --- 18.10.2024.
    
    \item Доклад за представяне на симулатор за обобщени мрежи пред ИБФБМИ --- 04.2024.
\end{itemize}
\end{frame}
